# Generated by Django 2.2.5 on 2020-06-17 20:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filepath', models.FileField(default='', upload_to='files/')),
                ('collection_drive_date', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.collection_drive')),
                ('donation_drive_date', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.donation_drive')),
            ],
            options={
                'db_table': 'reports',
            },
